  ...
  return (
    <div className="pt-32 md:pt-48 pb-32 px-6 max-w-4xl mx-auto min-h-screen">
      ...
      <div className="space-y-12 text-[#A1A1AA] leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4 tracking-[-0.02em]">2. Comprehensive Disclosures and Limitations of Liability</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4 tracking-[-0.02em]">3. User Account, AML/KYC Protocols, and Security</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4 tracking-[-0.02em]">4. Financial Execution Risk</h2>
          <p>
        ...
        <section>
          <h2 className="text-2xl font-bold text-white mb-4 tracking-[-0.02em]">5. Intellectual Property and API Usage</h2>
          <p>
        ...
        <div className="pt-12 border-t border-white/10">
          <p className="text-sm">
            For further legal inquiries, subpoena requests, or to dispatch a formal notice, contact our legal counsel at <a href="mailto:legal@tranzo.money" className="text-white hover:underline">legal@tranzo.money</a>. All jurisdictional disputes will be settled in the courts of Delaware, USA.
          </p>
        </div>
      </div>
    </div>
