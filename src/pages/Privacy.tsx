  ...
  return (
    <div className="pt-32 md:pt-48 pb-32 px-6 max-w-4xl mx-auto min-h-screen">
      ...
      <div className="space-y-12 text-[#727272] leading-relaxed">
        <section>
          <h2 className="text-2xl font-bold text-black mb-4 tracking-[-0.02em]">1. Comprehensive Data Collection Protocols</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-black mb-4 tracking-[-0.02em]">2. Third-Party Syndication, Aggregation, and Data Sharing</h2>
          <p className="text-justify">
        ...
        <section>
          <h2 className="text-2xl font-bold text-black mb-4 tracking-[-0.02em]">3. Deep Cookies, Tracking Pixels, and Telemetry Vectors</h2>
          <p className="text-justify">
        ...
        <section>
          <h2 className="text-2xl font-bold text-black mb-4 tracking-[-0.02em]">4. GDPR, CCPA, and Intenational Data Rights</h2>
        ...
        <div className="pt-12 border-t border-black/10 mt-20 text-center md:text-left">
          <p className="text-sm">
            For complex data extraction requests or DPO communications, contact our compliance division at <a href="mailto:privacy@tranzo.money" className="text-black hover:underline font-bold">privacy@tranzo.money</a>.
          </p>
        </div>
      </div>
    </div>
